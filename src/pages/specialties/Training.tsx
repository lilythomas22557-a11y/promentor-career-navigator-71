...
const Training = () => {
  const roles = [
    ...
    "DevOps Engineer", "Data Engineer", "Financial Analyst", "Business Intelligence Analyst",
    "Front End Developer", "QA Tester", "Solutions Architect"
  ];
    ...
    <div className="min-h-screen">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12 animate-fade-in">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ProMentor LLC's training programs encompass an extensive curriculum that delves into a wide 
                spectrum of subjects vital for career growth. From data analysis and operational strategies to business 
                analyst roles, data science, artificial intelligence, and beyond, our training aims to empower candidates 
            ...
            <div className="mb-16 animate-fade-in">
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                We recognize the importance of flexible learning, thus providing various options including traditional 
                classroom-based sessions, online courses, and self-paced modules. This flexibility allows candidates to 
                learn at their convenience while adapting to their busy schedules.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Our commitment to hands-on learning extends to the provision of real-world scenarios during training, 
                enabling candidates to apply theoretical concepts to practical settings. This experiential approach ensures 
                that they are well-prepared to tackle challenges in their selected fields. In essence, our training programs 
                have the potential to significantly impact both candidates' careers and the businesses that harness their skills.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              {[
                ...
                <Card key={index} className="hover:shadow-corporate transition-shadow duration-300 animate-slide-up" style={{ animationDelay: `${index * 0.1}s` }}>
      ...
      <section className="py-20 bg-secondary">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-muted-foreground">Connect with us:</p>
